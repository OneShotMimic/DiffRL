...
class TrajOpt:
    def __init__(self, cfg):
        ...
        self.actor = models.actor.ActorActionEmbedding(self.num_actions, self.steps_num, device = self.device)
    ...
    @torch.no_grad()
    def evaluate_policy(self, num_games):
        episode_length_his = []
        episode_loss_his = []
    ...
    def save(self, filename = None):
        ...
        torch.save([self.actor], os.path.join(self.log_dir, "{}.pt".format(filename)))
